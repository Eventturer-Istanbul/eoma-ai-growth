  ...
  const useCases = [
    {
      ...
      action:
        "EOMA shifts your Meta Ads targeting to Gen Z nostalgia audiences, updates your Instagram content calendar, and adjusts your email campaigns—ready for your review before you finish your coffee.",
      color: "teal",
      icon: (
        <svg
          className="w-6 h-6"
    ...
    },
    {
      ...
      action:
        "EOMA generates an SEO-optimized blog post based on your brand voice, creates matching social snippets, and pushes everything to your CMS—ready for your approval.",
      color: "coral",
      icon: (
        <svg
          className="w-6 h-6"
    ...
    },
    {
      ...
      action:
        "EOMA creates tasks in Notion for each deliverable, sets up tracking links, drafts influencer outreach emails, and schedules reminder notifications—your whole workflow, structured and ready for your sign-off.",
      color: "lavender",
      icon: (
        <svg
          className="w-6 h-6"
          ...
          {useCases.map((useCase, index) => {
            ...
            return (
              ...
              >
                {/* Gradient accent */}
                <div
                  className={`absolute top-0 left-0 w-1 h-full ${colors.line}`}
                />

                <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                  {/* Icon */}
                  <div
                    className={`${colors.bg} ${colors.text} p-4 rounded-xl flex-shrink-0`}
                  >
                    {useCase.icon}
                  </div>
