...
const GoogleAdsLogo = () => (
  <svg viewBox="0 0 24 24" className="w-8 h-8">
    <path
      fill="#FBBC04"
      d="M3.9 12c0-1.2.4-2.3 1.1-3.3L1.6 5.3C.6 7.1 0 9.2 0 12c0 2.8.6 5 1.6 6.7l3.4-3.4C4.3 14.3 3.9 13.2 3.9 12z"
    />
    <path
      fill="#4285F4"
      d="M12 3.9c2.2 0 4.1.8 5.6 2.1l3.3-3.3C18.7 1 15.6 0 12 0 7.4 0 3.5 2.6 1.6 6.3l3.4 3.4C6.1 6.7 8.8 3.9 12 3.9z"
    />
    <path
      fill="#34A853"
      d="M12 20.1c-3.2 0-5.9-2.8-6.9-5.8l-3.4 3.4C3.5 21.4 7.4 24 12 24c3.5 0 6.6-1.4 8.9-3.7l-3.2-3.2c-1.4 1.3-3.4 3-5.7 3z"
    />
    <path
      fill="#EA4335"
      d="M20.1 12c0-.8-.1-1.6-.3-2.3H12v4.6h4.5c-.2 1.1-.8 2-1.7 2.7l3.2 3.2c1.9-1.8 3.1-4.5 3.1-8.2z"
    />
  </svg>
);
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          Connect all your marketing tools and let EOMA handle the
          orchestration. No more tab-switching. No more copy-pasting.
        </motion.p>
