...
const LayerSection = ({
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-32 px-6 overflow-hidden">
      {/* Decorative line */}
      <div
        className={`absolute top-1/2 ${isReversed ? "right-0" : "left-0"} w-1/3 h-[1px] ${colors.line} opacity-20`}
      />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex-1">
            ...
            >
              <span
                className={`${colors.text} font-medium text-sm tracking-wider uppercase mb-4 block`}
              >
                Layer {layerNumber}
              </span>
